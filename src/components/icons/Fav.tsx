...
const Fav = () => {
	return (
		<svg className='w-[20px] h-[20px] fill-[#a5dbff80] hover:fill-[#f44f4f] transition-all' xmlns="http://www.w3.org/2000/svg" fill="#000000" width="800px" height="800px" viewBox="0 0 32 32" version="1.1">
